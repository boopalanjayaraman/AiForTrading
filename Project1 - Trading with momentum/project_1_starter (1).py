...
def analyze_alpha(expected_portfolio_returns_by_date):
    ...
    """
    # TODO: Implement Function
    mean = expected_portfolio_returns_by_date.mean()
    std = expected_portfolio_returns_by_date.std()
    standard_error = expected_portfolio_returns_by_date.sem()
    t_stat = mean / standard_error
    p_val = stats.ttest_1samp(expected_portfolio_returns_by_date, mean)/2
    return t_stat, p_val
